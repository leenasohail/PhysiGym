...
#   2. python3 custom_modules/physigym/physigym/envs/run_physigym_spatial.py
#
# description:
#   python script to run a single episode from the physigym model.
#####
