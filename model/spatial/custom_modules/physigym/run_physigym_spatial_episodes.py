#####
# title: run_physigym_spatial_episodes.py
#
# language: python3
#
# date:
...
#   2. python3 custom_modules/physigym/physigym/envs/run_physigym_spatial_episode.py
#
# description:
#   python script to run multiple episodes from the physigym model.
#####
