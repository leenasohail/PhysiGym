...
class ModelPhysiCellEnv(CorePhysiCellEnv):
    ...
    def get_observation_space(self):
        ...
        if self.observation_type == "simple":
            o_observation_space = spaces.Box(
                low=0, high=2**4, shape=(1,), dtype=np.float32
            )
    ...
    def get_observation(self):
        ...
        # Be carefull self.df_cell.dead returns a value which can be different 0 or 1 can cause some troubles
    ...
    def get_terminated(self):
        ...
        b_terminated = self.np_ratio_nb_cancer_cells > 4
        return b_terminated
