# physigym tumor_immune_bigred project
...
+ python library dependencies:
    ...
    pip3 install -r model/tumor_immune_bigred/custom_modules/physigym/requirements.txt
...
+ authors:
    ...
    modified work 2024-2025, Alexandre Bertin, Owen Griere tumor_immune_bigred model. \
    modified work 2024-2025, Alexandre Bertin, Elmar Bucher run_physigym_tip_sac.py.
...
+ almost the whole part of the coming from tumor_immune_paper but the config folder is coming from tibbue
