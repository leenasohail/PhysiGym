...
## Solutions
- **Problem 1**: The slowdown was caused by the Replay Buffer (fixed). Another solution would be to use PPO instead of SAC.
- **Problem 2**: Compute multiple environment dynamics under different strategies (done), and compute an Information Criterion (IC).
- **Problem 3**: 
